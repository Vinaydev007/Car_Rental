...
function function1() {
    if (getCity.value=="Select City" || getFrom.value=="" || getTo.value==""){
        ...
        // console.log(getFrom.value);
        // console.log(typeof getTo.value);
        // console.log(getTo.value-getFrom.value);   //NAN
        // console.log(getFrom.value.getFullYear());
        // console.log(getFrom.value.getMonth());
        // console.log(getFrom.value.getDay());
        // let d1=new Date(getFrom.value);
        // let d2=new Date(getTo.value);
